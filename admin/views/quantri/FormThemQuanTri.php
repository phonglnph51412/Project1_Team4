                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Form Them Quan Tri</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap Name" name="ho_ten">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="(+84) 035 763 8864" name="so_dien_thoai">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Trinh Van Bo Nam Tu Liem Ha Noi" name="dia_chi">
                                                        <span class="text-danger">
