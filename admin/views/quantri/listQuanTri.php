                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Danh sach tai khoan quan tri </h4>
                                            ...
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $quanTri['chuc_vu_id'] == 1 ? 'ADMIN':'Khach Hang';?></td>
                                                        ...
                                                        <td>
                                                          <div class="hstack gap-3 flex-wrap">
                                                                        ...
                                                                        <form action="?act=xoa-tai-khoan-quan-tri" method="POST" onsubmit="return confirm('ban co dong y xoa khong')">
