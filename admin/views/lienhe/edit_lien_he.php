                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập tên liên hệ" name="ten_lien_he" value="<?=$lienHe['ten_lien_he']?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select  class="form-select" name="trang_thai_lh">
                                                            ...
                                                            <option value="1"<?= $lienHe['trang_thai_lh']==1 ? 'selected' : '' ?>>hiển thị</option>
                                                            <option value="2"<?= $lienHe['trang_thai_lh']==2 ? 'selected' : '' ?>>không hiển thị</option>
                                                        </select>
                                                        <span class="text-danger">
