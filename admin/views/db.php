                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $count) ?  $count : 0; ?>">0</span> </h4>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $dem) ?  $dem : 0; ?>">0</span></h4>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $demkh) ?  $demkh : 0; ?>">0</span> </h4>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $sum) ?  $sum : 0; ?>">0</span>đ </h4>
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $choXacNhan) ?  $choXacNhan : 0; ?>">0</span> </h4>
                                                </div>
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $daXacNhan) ?  $daXacNhan : 0; ?>">0</span> </h4>
                                                </div>
                                                <div class="flex-shrink-0" style="margin-left: 20px;">
                                                    <h5 class="text-success fs-14 mb-0">
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $dangGiao) ?  $dangGiao : 0; ?>">0</span> </h4>
                                                </div>
                                                <div class="flex-shrink-0" style="margin-left: 20px;">
                                                    <h5 class="text-success fs-14 mb-0">
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $daGiao) ?  $daGiao : 0; ?>">0</span> </h4>
                                                </div>
                                                <div class="flex-shrink-0" style="margin-left: 20px;">
                                                    <h5 class="text-success fs-14 mb-0">
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Giao hàng thất bại  </p>
                                                </div>
                                                
                                            </div>
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $thatBai) ?  $thatBai : 0; ?>">0</span> </h4>
                                                </div>
                                                <div class="flex-shrink-0" style="margin-left: 20px;">
                                                    <h5 class="text-success fs-14 mb-0">
                                                        <i class="ri-arrow-right-up-line fs-13 align-middle"></i> +17.08 %
                                                    </h5>
                                                </div>
                                                <div class="avatar-sm flex-shrink-0">
                                                    <span class="avatar-title bg-success-subtle rounded fs-3">
                                                        <i class="bx bx-error-circle text-success"></i>
                                                    </span>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                ...
                                <div class="col-xl-3 col-md-6" style="width: 180px;">
                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?php echo isset( $huy) ?  $huy : 0; ?>">0</span> </h4>
                                                </div>
                                                <div class="flex-shrink-0" style="margin-left: 20px;">
                                                    <h5 class="text-success fs-14 mb-0">
                                                ...
                                                <?php foreach ($listNamDonHang as $index => $donHang) : ?>
                                                    <li class="order-item" >
                                                        <div class="order-info">
                                                            <span class="order-label" style="font-weight: bold;color: #333; font-size: 12px; margin-right: 10px;text-transform: uppercase;">Mã Đơn Hàng: </span> <span class="order-value"><?php echo $donHang['ma_don_hang']; ?></span>
                                                        </div><br>
                                                        <div class="order-info">
                                                            <span class="order-label"  style="font-weight: bold;color: #333; font-size: 12px; margin-right: 10px;text-transform: uppercase;">Tên Khách Hàng: </span> <span class="order-value" style="text-transform: uppercase;"><?php echo $donHang['ten_nguoi_nhan']; ?></span>
                                                        </div><br>
                                                        <div class="order-info">
                                                            <span class="order-label"  style="font-weight: bold;color: #333; font-size: 12px; margin-right: 10px;text-transform: uppercase;">Ngày Đặt: </span> <span class="order-value"><?php echo $donHang['ngay_dat']; ?></span>
                                                        </div><br>
                                                        <div class="order-info">
